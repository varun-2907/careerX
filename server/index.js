...
app.post('/api/recommendation', async (req, res) => {
  ...
  if (mockOnly) {
    ...
    const recommendations = [
      { title: 'Software Engineer (CSE)', salary: '₹4–10 LPA', growth: 'High', reason: 'Strong fit for core coding and system design fundamentals.' },
      { title: 'Full-Stack Developer (CSE)', salary: '₹5–12 LPA', growth: 'High', reason: 'Blends frontend UX with backend APIs for end-to-end product impact.' },
      { title: 'Backend Engineer (CSE)', salary: '₹6–14 LPA', growth: 'High', reason: 'Scales services, databases, and distributed systems reliably.' },
      { title: 'Frontend Engineer (CSE)', salary: '₹4–10 LPA', growth: 'High', reason: 'Builds responsive, accessible UIs that drive engagement.' },
      { title: 'DevOps Engineer (CSE)', salary: '₹7–16 LPA', growth: 'High', reason: 'Automates deployment pipelines and improves reliability.' },
      { title: 'Cloud Engineer (CSE)', salary: '₹7–16 LPA', growth: 'High', reason: 'Designs scalable cloud infrastructure for modern apps.' },
      { title: 'Site Reliability Engineer (CSE)', salary: '₹8–18 LPA', growth: 'High', reason: 'Ensures uptime and performance through automation and monitoring.' },
      { title: 'Data Engineer (CSE)', salary: '₹7–16 LPA', growth: 'High', reason: 'Builds pipelines and warehouses for large-scale analytics.' },
      { title: 'Data Analyst (CSE)', salary: '₹3–8 LPA', growth: 'High', reason: 'Transforms data into business insights and KPIs.' },
      { title: 'Data Scientist (CSE)', salary: '₹8–18 LPA', growth: 'High', reason: 'Applies statistical models and ML to solve complex problems.' },
      { title: 'Machine Learning Engineer (CSE)', salary: '₹9–20 LPA', growth: 'High', reason: 'Productionizes ML models for real-world use cases.' },
      { title: 'AI Engineer (CSE)', salary: '₹9–20 LPA', growth: 'High', reason: 'Builds AI-powered systems and intelligent features.' },
      { title: 'NLP Engineer (CSE)', salary: '₹9–18 LPA', growth: 'High', reason: 'Specializes in language models and text intelligence.' },
      { title: 'Computer Vision Engineer (CSE)', salary: '₹9–18 LPA', growth: 'High', reason: 'Builds systems for image and video understanding.' },
      { title: 'Cybersecurity Analyst (CSE)', salary: '₹6–14 LPA', growth: 'High', reason: 'Protects systems, networks, and user data.' },
      { title: 'Security Engineer (CSE)', salary: '₹8–18 LPA', growth: 'High', reason: 'Designs secure systems and vulnerability defenses.' },
      { title: 'Blockchain Developer (CSE)', salary: '₹7–16 LPA', growth: 'Medium', reason: 'Builds smart contracts and decentralized applications.' },
      { title: 'Game Developer (CSE)', salary: '₹4–10 LPA', growth: 'Medium', reason: 'Creates interactive experiences with real-time systems.' },
      { title: 'Mobile App Developer (CSE)', salary: '₹5–12 LPA', growth: 'High', reason: 'Builds iOS/Android apps with strong user retention.' },
      { title: 'QA Automation Engineer (CSE)', salary: '₹4–10 LPA', growth: 'Medium', reason: 'Ensures software quality with scalable test automation.' },
      { title: 'Embedded Systems Engineer (ECE)', salary: '₹5–12 LPA', growth: 'High', reason: 'Builds firmware for microcontrollers and IoT devices.' },
      { title: 'IoT Engineer (ECE)', salary: '₹5–12 LPA', growth: 'High', reason: 'Connects devices to cloud systems with secure protocols.' },
      { title: 'VLSI Design Engineer (ECE)', salary: '₹7–18 LPA', growth: 'High', reason: 'Designs integrated circuits and high-performance chips.' },
      { title: 'ASIC Design Engineer (ECE)', salary: '₹7–18 LPA', growth: 'High', reason: 'Creates custom silicon for specialized computing.' },
      { title: 'FPGA Engineer (ECE)', salary: '₹6–15 LPA', growth: 'High', reason: 'Implements hardware logic for performance-critical systems.' },
      { title: 'RF Engineer (ECE)', salary: '₹6–14 LPA', growth: 'Medium', reason: 'Designs wireless communication components and antennas.' },
      { title: 'Signal Processing Engineer (ECE)', salary: '₹7–16 LPA', growth: 'High', reason: 'Analyzes and improves signals for audio, radar, and comms.' },
      { title: 'Control Systems Engineer (ECE)', salary: '₹6–14 LPA', growth: 'Medium', reason: 'Develops automation and stability for complex systems.' },
      { title: 'Robotics Engineer (ECE)', salary: '₹7–18 LPA', growth: 'High', reason: 'Builds intelligent robots with sensors and control logic.' },
      { title: 'Embedded AI Engineer (ECE)', salary: '₹8–18 LPA', growth: 'High', reason: 'Deploys ML models on edge devices efficiently.' },
      { title: 'Hardware Validation Engineer (ECE)', salary: '₹5–12 LPA', growth: 'Medium', reason: 'Tests hardware reliability and compliance at scale.' },
      { title: 'Electronics Design Engineer (ECE)', salary: '₹5–12 LPA', growth: 'Medium', reason: 'Creates PCB designs and electronic circuits.' },
      { title: 'Power Electronics Engineer (ECE)', salary: '₹6–14 LPA', growth: 'Medium', reason: 'Works on converters, inverters, and energy systems.' },
      { title: 'Telecom Engineer (ECE)', salary: '₹4–10 LPA', growth: 'Medium', reason: 'Designs and optimizes telecom networks and systems.' },
      { title: 'Network Engineer (ECE)', salary: '₹4–10 LPA', growth: 'High', reason: 'Builds and secures enterprise networking infrastructure.' },
      { title: 'AR/VR Engineer (CSE)', salary: '₹7–16 LPA', growth: 'Medium', reason: 'Builds immersive experiences using 3D engines.' },
      { title: 'Systems Engineer (CSE)', salary: '₹6–14 LPA', growth: 'High', reason: 'Integrates software, hardware, and requirements at scale.' },
      { title: 'Product Engineer (CSE)', salary: '₹6–14 LPA', growth: 'High', reason: 'Bridges engineering with product strategy for impact.' },
      { title: 'Technical Program Manager (CSE)', salary: '₹10–22 LPA', growth: 'High', reason: 'Coordinates complex technical delivery across teams.' },
      { title: 'Research Engineer (CSE)', salary: '₹9–20 LPA', growth: 'Medium', reason: 'Explores novel methods and prototypes new systems.' },
    ]
